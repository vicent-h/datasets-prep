...
class NumbersClash(Processor):
    ...
    def identify_numbers(self, text: str) -> list:
        """
    ...
    def apply_pairs(self, text1: str, text2: str, **kwargs) -> tuple:
        ...
        if(len(numbers1) == 0 or len(numbers2) == 0):
            return (text1, text2), True, {'number_clash_similarity': 1.0} # If either text has no numbers, consider it a match (no clash)
        ...
        return (text1, text2), eval, {'number_clash_similarity': similarity}